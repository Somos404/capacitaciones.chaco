...
$THEME->layouts = [
    ...
    'standard' => array(
        'file' => 'columns2.php',
        'regions' => array('fullwidth-top', 'fullwidth-bottom', 'above-content', 'below-content', 'left', 'side-pre', 'navbar'),
...
$THEME->sheets = array('bootstrap.min', 'jquery-ui.min', 'font-awesome.min', 'font-awesome-animation.min', 'line-awesome.min', 'menu', 'ace-responsive-menu', 'megadropdown', 'bootstrap-select.min', 'simplebar.min', 'progressbar', 'ccn-flaticon', 'flaticon', 'animate', 'slider', 'magnific-popup', 'timecounter', 'jquery.fancybox.min', 'cocoon', 'responsive', 'cocoon-mdl', 'cocoon-dashboard');
...
$THEME->javascripts = array('jquery-migrate-3.0.0.min', 'cocoon.preprocess', 'cocoon.dashboard.preprocess', 'jquery.mmenu.all', 'ace-responsive-menu', 'bootstrap-select.min', 'isotop', 'snackbar.min', 'simplebar', 'parallax', 'scrollto', 'jquery-scrolltofixed-min', 'jquery.counterup', 'wow.min', 'progressbar', 'slider', 'timepicker', 'jquery.youtubebackground', 'jquery.fancybox.min', 'script');
