...
} elseif($breadcrumb_clip_setting == 2) { // Uppercase
  $breadcrumb_classes .= ' ccn-caps-upper ';
} elseif($breadcrumb_clip_setting == 3) { // None
...
// }
$extraclasses = array('ccn_header_style_' . $headertype, 'ccn_footer_style_' . $footertype, 'ccn_blog_style_' . $blogstyle, 'ccn_course_list_style_' . $courseliststyle, $user_status, $ccn_frontcheck, $headertype_settings_class, $dash_header_setting_class);
...
} elseif($incourse_layout_setting == 1 && $context->id != $context_site->id && !$courseMainPage){
...
} elseif($course_mainpage_layout_setting == 1 && $context->id != $context_site->id && $is_enrolled){
  // $course_mainpage_layout_dashboard = 1;
  $course_mainpage_layout_dashboard = 0;
} elseif($course_mainpage_layout_setting == 2 && $context->id != $context_site->id){
  // $course_mainpage_layout_dashboard = 1;
  $course_mainpage_layout_dashboard = 0;
} else {
  $course_mainpage_layout_dashboard = 0;
