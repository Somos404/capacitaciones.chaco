$(function() {
  ...
  $(document).ready(function() {
    ...
    // });
    $("body.ccn_header_style_7:not(.ccn_context_dashboard),body.ccn_header_style_3:not(.ccn_context_dashboard),body.ccn_header_style_4:not(.ccn_context_dashboard),body.ccn_header_style_5:not(.ccn_context_dashboard),body.ccn_header_style_6:not(.ccn_context_dashboard),body.ccn_header_style_8:not(.ccn_context_dashboard)").each(function() {
      var list = $('ul#respMenu');
      var listItems = list.children('li');
      list.append(listItems.get().reverse());
    });
...
// }
  ...
  $(window).on('load', function() {
    ...
    // $('#ccn-star-rate input[type=radio]').on('change', function() {
