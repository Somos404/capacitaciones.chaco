...
class block_cocoon_parallax_apps extends block_base {
    ...
    function get_content() {
		...
		<div class="container">
			<div class="row">
				<div class="col-md-7 col-lg-7">
					<div class="app_grid">
						...
						<a class="ccn-app-grid-btn" target="'.$data->app_store_btn_target.'" href="'.format_text($data->app_store_btn_link, FORMAT_HTML, array('filter' => true)).'"><button class="apple_btn btn-transparent">
							<span class="icon">
            ...
            <a class="ccn-app-grid-btn" target="'.$data->play_store_btn_target.'" href="'.format_text($data->play_store_btn_link, FORMAT_HTML, array('filter' => true)).'">
