...
class block_cocoon_featuredcourses_edit_form extends block_edit_form {
    ...
    protected function specific_definition($mform) {
        ...
        $mform->addElement('html', '<a class="btn btn-secondary mt20 mb30 " href="'.$CFG->wwwroot.'/blocks/cocoon_featuredcourses/cocoon_featuredcourses.php">Select Featured Courses</a>');
