                   ...
                   <div class="row">
                      <div class="col-sm-12">
                        <div class="form-group">
                          <label for="name" id="namelabel" style="font-family: Arial, Helvetica, sans-serif; font-size: large;">'.get_string('your_name', 'theme_edumy').'</label>
                      ...
                      <div class="col-sm-12">
                        <div class="form-group">
                          <label for="email" id="emaillabel" style="font-family: Arial, Helvetica, sans-serif; font-size: large;">'.get_string('email_address', 'theme_edumy').'</label>
                     ...
                     <div class="col-sm-12">
                        <div class="form-group">
                          <label for="subject" id="subjectlabel" style="font-family: Arial, Helvetica, sans-serif; font-size: large;">'.get_string('subject', 'theme_edumy').'</label>
                     ...
                     <div class="col-sm-12">
                        <div class="form-group">
                          <label for="message" id="messagelabel" style="font-family: Arial, Helvetica, sans-serif; font-size: large;">'.get_string('message', 'theme_edumy').'</label>
