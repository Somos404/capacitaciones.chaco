        ...
        <div class="container">
          <div class="row mb60">
            ...
            <div class="col-lg-10 text-center mt40 offset-lg-1">
              ...
              if($this->content->counter_1 || $this->content->counter_1_text || $this->content->counter_1_icon){
                $this->content->text .='
                <div class="'.$col_class.'">
                  <div class="funfact_two '.$class.'">
                    <div class="home_icon_box home6">';
                      if($this->content->counter_1_icon){
                      $this->content->text .='
                        <div class="icon ccn-icon-reset">
                          <i class="'.$this->content->counter_1_icon.'"></i>
                        </div>';
                      }
                      $this->content->text .='
                      <div class="details">
                        ...
                        if($this->content->counter_1_after){$this->content->text .='<span class="ccn-timer-after">'.format_text($this->content->counter_1_after, FORMAT_HTML, array('filter' => true)).'</span>';}
                        $this->content->text .='
                      </div>
                    </div>
                  </div>
              ...
              if($this->content->counter_2 || $this->content->counter_2_text || $this->content->counter_2_icon){
                $this->content->text .='
                <div class="'.$col_class.'">
                  <div class="funfact_two '.$class.'">
                    <div class="home_icon_box home6">';
                      if($this->content->counter_2_icon){
                      $this->content->text .='
                        <div class="icon ccn-icon-reset">
                      ...
                      <div class="details">
                        ...
                        if($this->content->counter_2_after){$this->content->text .='<span class="ccn-timer-after">'.format_text($this->content->counter_2_after, FORMAT_HTML, array('filter' => true)).'</span>';}
                        $this->content->text .='
                      </div>
                    </div>
                  </div>
              ...
              if($this->content->counter_3 || $this->content->counter_3_text || $this->content->counter_3_icon){
                $this->content->text .='
                <div class="'.$col_class.'">
                  <div class="funfact_two '.$class.'">
                    <div class="home_icon_box home6">';
                      if($this->content->counter_3_icon){
                      $this->content->text .='
                        <div class="icon ccn-icon-reset">
                      ...
                      <div class="details">
                        ...
                        if($this->content->counter_3_after){$this->content->text .='<span class="ccn-timer-after">'.format_text($this->content->counter_3_after, FORMAT_HTML, array('filter' => true)).'</span>';}
                        $this->content->text .='
                      </div>
                    </div>
                  </div>
              ...
              if($this->content->counter_4 || $this->content->counter_4_text || $this->content->counter_4_icon){
                $this->content->text .='
                <div class="'.$col_class.'">
                  <div class="funfact_two '.$class.'">
                    <div class="home_icon_box home6">';
                      if($this->content->counter_4_icon){
                      $this->content->text .='
                        <div class="icon ccn-icon-reset">
                      ...
                      <div class="details">
                        ...
                        if($this->content->counter_4_after){$this->content->text .='<span class="ccn-timer-after">'.format_text($this->content->counter_4_after, FORMAT_HTML, array('filter' => true)).'</span>';}
                        $this->content->text .='
                      </div>
                    </div>
                  </div>
