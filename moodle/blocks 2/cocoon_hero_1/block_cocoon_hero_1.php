    ...
    public function get_content(){
        ...
        <section class="home-three home3-overlay home3_bgi6" style="background-image:url('.$url.');background-size:cover;">
      		<div class="container">
                  ...
                  if($videoPopup){
                    $this->content->text .='<a data-fancybox class="btn home_btn ccn_video_trigger_btn_icon" href="'.$vidURL.'">'.format_text($this->content->button_text, FORMAT_HTML, array('filter' => true)).' <i class="flaticon-play-button"></i></a>';
                  } else {
                    $this->content->text .='<a class="btn home_btn" href="'.format_text($this->content->button_link, FORMAT_HTML, array('filter' => true)).'">'.format_text($this->content->button_text, FORMAT_HTML, array('filter' => true)).'</a>';
                  }
                  $this->content->text .='
      					</div>
      				</div>
