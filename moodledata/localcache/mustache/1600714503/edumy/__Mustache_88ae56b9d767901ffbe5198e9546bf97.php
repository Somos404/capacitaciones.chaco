...
class __Mustache_88ae56b9d767901ffbe5198e9546bf97 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionD0ff859c7a24c09366407a71f0aa495d($context, $indent, $value);
        $buffer .= '
';
        $buffer .= $indent . '        ';
        // 'inprogress' section
...
';
        ...
        // 'str' section
        $value = $context->find('str');
        $buffer .= $this->section761dbfc06174c0e0db878af78cb547d3($context, $indent, $value);
        $buffer .= '
';
        $buffer .= $indent . '        </a>
';
...
';
    ...
    private function section761dbfc06174c0e0db878af78cb547d3(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = ' allexcepthidden, theme_edumy ';
            $result = call_user_func($value, $source, $this->lambdaHelper);
            if (strpos($result, '{{') === false) {
                $buffer .= $result;
            } else {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= ' allexcepthidden, theme_edumy ';
                $context->pop();
            }
        }
    ...
    private function sectionD0ff859c7a24c09366407a71f0aa495d(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '{{#str}} allexcepthidden, theme_edumy {{/str}}';
            $result = call_user_func($value, $source, $this->lambdaHelper);
            if (strpos($result, '{{') === false) {
                $buffer .= $result;
            } else {
