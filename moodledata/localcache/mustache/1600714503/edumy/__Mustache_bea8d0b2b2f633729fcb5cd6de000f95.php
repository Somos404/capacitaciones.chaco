...
class __Mustache_bea8d0b2b2f633729fcb5cd6de000f95 extends Mustache_Template
{
...
';
        ...
        $buffer .= '" href="#" data-view="month" data-year="';
...
';
        ...
        $value = $context->find('viewingupcoming');
        $buffer .= $this->section5749c750acb0d7477dd5257d00cc6d53($context, $indent, $value);
        $buffer .= '" href="#" data-view="upcoming" data-year="';
        $value = $this->resolveValue($context->findDot('date.year'), $context);
        $buffer .= call_user_func($this->mustache->getEscape(), $value);
        $buffer .= '" data-month="';
        $value = $this->resolveValue($context->findDot('date.mon'), $context);
