...
class __Mustache_dc706e90982bb26142e0e42021fe7ae2 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $indent . '<header class="header-nav menu_style_home_one navbar-scrolltofixed stricky main-menu">
';
...
';
        ...
        $buffer .= $this->section7ba7159386ebed59e6a8a372c2e26810($context, $indent, $value);
...
';
    ...
    private function section7ba7159386ebed59e6a8a372c2e26810(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
        <a href="{{{ config.wwwroot }}}" class="navbar_brand float-left dn-smd">
